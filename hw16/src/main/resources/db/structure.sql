...
DROP INDEX IF EXISTS HW_USER_K01;
DROP INDEX IF EXISTS HW_USER_ROLE_K01;
...
CREATE INDEX HW_USER_K01 ON HW_USER(LOGIN);
...
CREATE TABLE HW_USER_ROLE(
    ...
    CONSTRAINT HW_COMMENT_FK01 FOREIGN KEY (ROLEID) REFERENCES HW_ROLE (ROLEID) ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT HW_COMMENT_FK02 FOREIGN KEY (USERID) REFERENCES HW_USER (USERID) ON UPDATE CASCADE ON DELETE CASCADE
);
CREATE UNIQUE INDEX HW_USER_ROLE_K01 ON HW_USER_ROLE(ROLEID, USERID);